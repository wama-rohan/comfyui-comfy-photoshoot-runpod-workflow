...
RUN comfy node install --exit-on-fail comfyui-ollama
...
RUN wget --progress=dot:giga -O '/comfyui/input/pexels-peterfazekas-1137340.jpg' "https://cool-anteater-319.convex.cloud/api/storage/b8bf959c-7e7d-4f42-b733-8076d5ec1d07"
RUN wget --progress=dot:giga -O '/comfyui/input/81bZ17IkmSL._SX679_.jpg' "https://cool-anteater-319.convex.cloud/api/storage/6068785b-fc18-4056-bb86-aece9c537a2d"
RUN wget --progress=dot:giga -O '/comfyui/input/pexels-alina-zahorulko-48514961-31445409.jpg' "https://cool-anteater-319.convex.cloud/api/storage/f38f62bd-0927-4ed6-ad32-da7fd37d7d0a"
RUN wget --progress=dot:giga -O '/comfyui/input/Indian_male_model_2.png' "https://cool-anteater-319.convex.cloud/api/storage/19f5811a-d1dc-4cb7-b3a5-2fbb81ad84d0"
RUN wget --progress=dot:giga -O '/comfyui/input/pexels-mimfathi-10919291.jpg' "https://cool-anteater-319.convex.cloud/api/storage/d10865f9-99d6-4a84-a6da-bc229d9e3dcf"
